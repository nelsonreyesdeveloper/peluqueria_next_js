...
const Page = () => {
  ...
  const { todosServicios, setServicios, marcarEstadoAceroTodos } = usePeluqueriaContext();
    ...
    <div>
      ...
      <div className='bg-black py-5'>
        <div className='w-[95%] flex flex-col md:flex-row  mx-auto justify-between'>
          ...
          <button onClick={() => { marcarEstadoAceroTodos(); setServicios([]); logout(); }} className='tex-center text-white font-bold uppercase hover:text-red-600'>Cerrar Sesion</button>
        </div>
      </div>
